...
class DeputadosSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        # with open('deputadas.csv', 'a') as file:
        #     writer = csv.writer(file)
    ...
    def parse_gastos_par(self, response, email, link_gastos_gab):
        ...
        deputados[email].append(gasto_total_par)
        deputados[email].extend(gastos)
    ...
    def parse_gastos_gab(self, response, email):
        ...
        with open('deputadas_deputados.csv', 'a') as file:
            writer = csv.writer(file)
            writer.writerow(deputados[email])
